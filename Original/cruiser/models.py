...
from cruiser.metrics import *


def get_model(model_name):
    if model_name == 'cruiser':
        return Cruiser
    elif model_name == 'offset_cruiser':
        return OffsetCruiser
...
class Cruiser(tf.keras.Model):
    ...
    def train_step(self, data):
        ret = super(Cruiser, self).train_step(data)
