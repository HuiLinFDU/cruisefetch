...
from cruiser.utils import get_parser, load_config
from cruiser.data_loader import read_benchmark_trace
from cruiser.logging import NBatchLogger
from cruiser.models import HierarchicalLSTM
...
def train_cruiser(config, benchmark, print_every=None, model_path=None):
    """Train/validate an instance of Cruiser."""
